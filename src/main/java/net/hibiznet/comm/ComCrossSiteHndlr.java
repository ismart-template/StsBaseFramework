...
/**
 * Cross-Site Scripting 泥댄겕�븯�뿬 媛믪쓣 �릺�룎�젮 諛쏅뒗 �빖�뱾�윭 JSP TLD, �옄諛붿뿉�꽌 �궗�슜媛��뒫
 *
 * @author 怨듯넻�꽌鍮꾩뒪 �옣�룞�븳
 * @since 2010.11.09
 * @version 1.0
 * @see <pre>
...
public class ComCrossSiteHndlr extends BodyTagSupport {
    ...
    /** 2011.10.10 cmd �씪�씤�긽�뿉�꽌 �렪�쓽�젣怨듭쓣 �쐞�빐 �젣怨�, �븘�슂�뾾�쓣�떆 �궘�젣�븯�뿬�룄 臾대갑�븿
